    ...
    >
      <div className="mx-auto w-full max-w-[var(--container-default)]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-stretch">
          {/* Content — flex col with space-between to push stats to bottom */}
          <motion.div
          ...
          >
            <div className="flex flex-col gap-8">
              ...
              >
                Faith-driven.
                <br />
                <span className="text-muted-foreground">Africa-focused.</span>
              </motion.h2>

              <motion.div
                variants={fadeUp}
                className="flex flex-col gap-5 text-base text-muted-foreground leading-[1.8]"
              >
                <p>
            ...
            {/* Stats — pinned to bottom, align with base of portrait */}
            <motion.div
              variants={fadeUp}
